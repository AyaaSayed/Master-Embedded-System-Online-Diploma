...
// EXTI_SWIER Bits
typedef struct{
	volatile uint32_t SWIER:20;
	volatile uint32_t Reserved:12;
}EXTI_SWIER_t;

// EXTI_PR Bits
typedef struct{
	volatile uint32_t PR:20;
	volatile uint32_t Reserved:12;
}EXTI_PR_t;
...
/****************General Purpose Input Output Peripheral (GPIO)****************/
// GPIOA , GPIOB fully included in LFP48 Packages
GPIO_t* GPIOA = (GPIO_t *)GPIOA_BASE;
GPIO_t* GPIOB = (GPIO_t *)GPIOB_BASE;

// GPIOC , GPIOD partial included in LFP48 Packages
GPIO_t* GPIOC = (GPIO_t *)GPIOC_BASE;
GPIO_t* GPIOD = (GPIO_t *)GPIOD_BASE;

// GPIOE not included in LFP48 Packages
GPIO_t* GPIOE = (GPIO_t *)GPIOE_BASE;
